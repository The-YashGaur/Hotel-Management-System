...
con = sqlite3.connect('hotel-management-system-master/hm_proj.db')
cur = con.cursor()
...
#-----------splash_screen------------------------------------------------------------------------------------------------------------------
sroot = Tk()
sroot.minsize(height=516,width=1300)
sroot.configure(bg='white')
spath = "C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\hotel.jpg"
...
Label(sroot,text="Made By- Yash Gaur",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="22164@iiitu.ac.in",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	path = "C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\newestbg5.jpg"
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Yash',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		'''
		emp1f = Frame(b_frame)
		path1 = "C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\newman.jpg"
		...
		Label(emp1inf,text="Mr. Abhishek Sharma",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		emp1f = Frame(b_frame)
		path2 = "C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\receptionnew.jpg"
		...
		Label(emp1inf,text="Ms. Raghav Khurana",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		emp1f = Frame(b_frame)
		path3 = "C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\fchefnew.jpg"
		...
		Label(emp1inf,text="Mr. Shobhit Jain (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		emp1f = Frame(b_frame)
		path4 = "C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\roomservicenew.jpg"
	...
	path = "C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\rooms.png"
	img = ImageTk.PhotoImage(Image.open(path))
	b1 = Button(sl_frame,image=img,text='b1',bg='white',width=180,command=rooms)
	b1.image = img
	b1.place(x=180,y=0)
	path2 = "C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\hotelstatus.png"
	img1 = ImageTk.PhotoImage(Image.open(path2))
	b2 = Button(sl_frame,image=img1,text='b2',bg='white',width=180,command=hotel_status)
	b2.image = img1
	b2.place(x=0,y=0)
	path3='C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\guests.png'
	img3 = ImageTk.PhotoImage(Image.open(path3))
	b3 = Button(sl_frame,image=img3,text='b2',bg='white',width=180,command=staff)
	b3.image = img3
	b3.place(x=180*4,y=0)
	path4='C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\payments.png'
	img4 = ImageTk.PhotoImage(Image.open(path4))
	b4 = Button(sl_frame,image=img4,text='b2',bg='white',width=180,command = payments)
	b4.image = img4
	b4.place(x=180*3,y=0)
	path5='C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\logout.png'
	...
	path6='C:\\Users\\gaur0\\OneDrive\\Desktop\\hotel-management-system-master\\hotel-management-system-master\\images\\Bookroom.png'
